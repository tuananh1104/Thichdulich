-- Reset toàn bộ dữ liệu tour mẫu và nạp lại bộ tour tiếng Việt chuẩn.
...
('tour-sapa-fansipan-3d', 'prov-0001-0000-0000-000000000001', 'dest-sapa',
 ...
 'Lào Cai', 'mountain', 3, 4299000, 3199000, 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1000&h=700&fit=crop', 4.8, 142, TRUE, 'approved', NOW() - INTERVAL 14 DAY, NOW() - INTERVAL 12 DAY, 'admin-0001-0000-0000-000000000001'),
